...
console.log('Start-call endpoint loaded');
...
const handler = async (req, res) => {
  ...
  if (req.method === 'GET') {
    return res.status(200).json({ 
      message: 'Start-call API is working! Use POST method with {"channelName":"your_channel"}',
      example: 'curl -X POST https://your-url/api/start-call -H "Content-Type: application/json" -d \'{"channelName":"testchannel"}\''
    });
  }
